...
(function() {
  ...
  ready = function() {
    $('#job-search').hide();
    return $('#job-form-toggle').on('click', function() {
      return $('#job-search').toggle(500);
    });
  };
...
(function() {
  ...
  ready = function() {
    ...
    return $('#all_orders_cal').fullCalendar({
      selectable: true,
      selectHelper: true,
      firstDay: 1,
      ...
      select: function(startDate, endDate, allDay) {
        $.get(window.location + '/new', {
          order: {
            begin_at: datefmt(startDate),
            end_at: datefmt(endDate)
          }
          ...
          $('#new_order').on('ajax:success', function(e, data, status, xhr) {
            ...
            return $('#all_orders_cal').fullCalendar('refetchEvents');
          });
          return $('#new_order').on('ajax:error', function(e, xhr, status, error) {
            var json;
            ...
            return $.each(json, function(k, v) {
              ...
              return $('#' + k + '_errors').html(v);
            });
          });
        }), "html");
        return $('#all_orders_cal').fullCalendar('unselect');
      }
    });
  };
        ...
        if (event.url) {
          ...
          $.get(path, (function(data) {
            ...
            $('#slider').slider({
              ...
              values: [8 * 60, 16 * 60],
              slide: function(e, ui) {
                var ahour, amin, bhour, bmin, delta;
                ...
                return $("#job_duration").val(delta / 60);
              }
            });
            $('#new_job').on('ajax:success', (function(e, data, st, xhr) {
              console.log(data);
              modal.modal('hide');
              return alert("Uusi työpäivä rekisteröity.");
            }));
            return $('#new_job').on('ajax:error', (function(e, xhr, status, error) {
              var json;
              json = $.parseJSON(xhr.responseText);
              $('.form-group').removeClass('has-error');
              $('.help-block').html('');
